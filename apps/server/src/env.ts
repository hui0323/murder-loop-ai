...
export const env = {
  ...
  deepseekKillerModel: process.env.DEEPSEEK_KILLER_MODEL || process.env.DEEPSEEK_MODEL || 'deepseek-v4pro',
  ...
  deepseekNpcModel: process.env.DEEPSEEK_NPC_MODEL || process.env.DEEPSEEK_MODEL || 'deepseek-v4pro',
  ...
  deepseekRecapModel: process.env.DEEPSEEK_RECAP_MODEL || process.env.DEEPSEEK_MODEL || 'deepseek-v4pro',
